...
class MultiModalDataset(Dataset):
    def __init__(self, spot_img_data_path, spot_gene_data_path, global_img_data_path, global_gene_data_path,
        ...
        self.all_global_img_path = [os.path.join(global_img_data_path, item) for item in
                                    os.listdir(global_img_data_path)]
        self.all_global_gene_path = [os.path.join(global_gene_data_path, item) for item in
                                     os.listdir(global_gene_data_path)]
    ...
    def __getitem__(self, idx):
        ...
        _, negtive_indices = get_positive_and_negatives(inner_idx, self.labels[idx_base_name])
